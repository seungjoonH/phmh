...
export const serviceAreasSectionsEn = {
  "depression": {
    "title": "Depression",
        ...
        "lists": [
          {
            ...
            "items": [
              "**Intrusive Memories & Reactions** — Flashbacks, nightmares, or distressing memories that feel hard to escape",
              "**Intrusive Memories & Reactions** — Sudden emotional or physical reactions to reminders of the trauma",
              "**Avoidance & Disconnection** — Avoiding people, places, or conversations that bring up painful memories",
              "**Avoidance & Disconnection** — Feeling emotionally numb or disconnected from yourself or others",
              "**Negative Thoughts & Mood Changes** — Ongoing guilt, shame, or self-blame",
              "**Negative Thoughts & Mood Changes** — Difficulty trusting others or feeling emotionally close",
              "**Negative Thoughts & Mood Changes** — Trouble remembering parts of the trauma or viewing the world as unsafe",
              "**Hyperarousal & Reactivity** — Constantly feeling on edge, easily startled, or overly alert",
              "**Hyperarousal & Reactivity** — Difficulty sleeping, concentrating, or managing energy levels",
              "**Hyperarousal & Reactivity** — Intense emotional reactions or difficulty regulating strong emotions"
            ]
          }
        ]
      },
  ...
  "suicidalThoughts": {
    ...
    "subsections": [
      ...
      {
        "heading": "Finding Light Again: Gentle Guidance Toward Hope and Healin",
        "groups": [
          [
        ...
        "lists": [
          {
            ...
            "items": [
              ...
              "**Crisis Support & Emotional Care** — Immediate support during moments of emotional overwhelm",
              "**Crisis Support & Emotional Care** — Tools to manage intense feelings and stay grounded",
              "**Crisis Support & Emotional Care** — Guidance in building a support system—people who genuinely care and want to walk beside you"
            ]
          }
        ]
      }
    ...
    "subsections": [
      {
        ...
        "lists": [
          {
            "items": [
              "**Manic or Hypomanic Episodes** — Surges of energy, excitement, or euphoria that feel hard to contain",
              "**Manic or Hypomanic Episodes** — Sleeping very little without feeling tired",
              "**Manic or Hypomanic Episodes** — Impulsive behaviors—risky spending, reckless decisions, or overcommitting",
              "**Manic or Hypomanic Episodes** — Racing thoughts, rapid speech, or difficulty focusing",
              "**Depressive Episodes** — Deep, lingering sadness or emotional numbness",
              "**Depressive Episodes** — Loss of interest in activities you once enjoyed",
              "**Depressive Episodes** — Fatigue or a heavy, slowed-down feeling in your body",
              "**Depressive Episodes** — Trouble concentrating or making everyday decisions",
              "**Depressive Episodes** — Feelings of hopelessness or thoughts of self-harm"
            ]
          }
        ]
      },
      {
        "heading": "Reclaiming Your Life: Finding Harmony Through Bipolar Disorde",
        "groups": [
          [
    ...
    "subsections": [
      {
        ...
        "lists": [
          {
            "items": [
              "**Inattention** — Trouble starting or completing tasks",
              "**Inattention** — Frequently losing everyday items like books, toys, or school supplies",
              "**Inattention** — Difficulty with organization, time management, or following multi-step directions",
              "**Inattention** — Easily distracted; struggling to focus for sustained periods",
              "**Hyperactivity & Impulsivity** — Constant movement, fidgeting, or restlessness",
              "**Hyperactivity & Impulsivity** — Talking excessively, interrupting others, or difficulty waiting their turn",
              "**Hyperactivity & Impulsivity** — Acting impulsively, often followed by frustration or regret",
              "**Hyperactivity & Impulsivity** — Difficulty managing emotions or following rules in group settings"
            ]
          }
        ]
      },
    ...
    "subsections": [
      {
        ...
        "lists": [
          {
            "items": [
              "**Obsessions (Intrusive Thoughts)** — Repetitive, unwanted thoughts, images, or urges",
              "**Obsessions (Intrusive Thoughts)** — Fears related to contamination, harm, or things being “not quite right”",
              "**Obsessions (Intrusive Thoughts)** — Growing anxiety if a thought isn’t “neutralized” or undone",
              "**Compulsions (Repetitive Behaviors)** — Repeated handwashing, checking, counting, or arranging",
              "**Compulsions (Repetitive Behaviors)** — A belief that something bad will happen unless a specific behavior is completed",
              "**Compulsions (Repetitive Behaviors)** — Rituals that interfere with daily life, relationships, or your sense of well-being"
            ]
          }
        ]
      },
        ...
        "lists": [
          {
            ...
            "items": [
              "**Anorexia Nervosa** — Ongoing food restriction and an intense fear of gaining weight",
              "**Anorexia Nervosa** — Anxiety around eating or maintaining a “normal” body size",
              "**Anorexia Nervosa** — Distorted body image and strict rules around food",
              "**Bulimia Nervosa** — Episodes of binge eating followed by purging (vomiting, laxatives, or over-exercising)",
              "**Bulimia Nervosa** — Strong preoccupation with weight and body shape",
              "**Bulimia Nervosa** — Feelings of shame, guilt, or distress after eating",
              "**Binge Eating Disorder** — Frequent episodes of eating beyond fullness, often with a sense of being out of control",
              "**Binge Eating Disorder** — Emotional numbness, self-criticism, or guilt following meals",
              "**Binge Eating Disorder** — May be associated with weight fluctuations or physical discomfort"
            ]
          }
        ]
      },
    ...
    "subsections": [
      {
        ...
        "lists": [
          {
            "items": [
              "**Social interaction and communication differences** — Avoiding eye contact or struggling with facial expressions and tone of voice",
              "**Social interaction and communication differences** — Difficulty with back-and-forth conversations or interpreting social cues",
              "**Social interaction and communication differences** — Needing extra time to process and express emotions",
              "**Repetitive behaviors and focused interests** — Intense attachment to routines, patterns, or specific interests",
              "**Repetitive behaviors and focused interests** — Discomfort with unexpected changes or transitions",
              "**Repetitive behaviors and focused interests** — Unusual sensitivity to lights, sounds, textures, or physical touch"
            ]
          }
        ]
      },
        ...
        "lists": [
          {
            ...
            "items": [
              ...
              "**Insomnia** — Waking up too early and being unable to return to sleep",
              "**Insomnia** — Persistent fatigue, even after sleeping",
              "**Sleep Apnea** — Breathing that stops or becomes shallow during sleep",
              "**Sleep Apnea** — Snoring or gasping for air",
              "**Sleep Apnea** — Daytime drowsiness, irritability, or difficulty focusing",
              "**Hypersomnia** — Excessive sleepiness despite getting enough sleep",
              "**Hypersomnia** — Struggling to stay awake during the day",
              "**Hypersomnia** — Difficulty functioning due to overwhelming fatigue",
              "**Nightmare Disorder** — Intense, distressing dreams that interrupt your sleep",
              "**Nightmare Disorder** — Lingering fear or anxiety around falling asleep",
              "**Nightmare Disorder** — Emotional exhaustion upon waking"
            ]
          }
        ]
      },
